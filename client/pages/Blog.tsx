        ...
        setBlogs([
          {
            ...
            content:
              "Learn the fundamentals of modern web development with React, TypeScript, and modern tooling.",
            excerpt:
              "A comprehensive guide to kickstart your web development journey with the latest technologies and best practices.",
          ...
          },
          {
            ...
            content:
              "Building scalable design systems that work across teams and products.",
            excerpt:
              "Learn how to create and maintain design systems that scale with your organization and improve team collaboration.",
          ...
          },
          {
            ...
            content:
              "Exploring trends and innovations shaping the future of digital commerce.",
            excerpt:
              "Discover what's coming next in the world of digital marketplaces and e-commerce technology.",
          ...
          },
          {
            ...
            content:
              "Complete guide to modern CSS layout techniques for responsive web design.",
            excerpt:
              "Master the art of creating responsive layouts with CSS Grid and Flexbox in this comprehensive tutorial.",
          ...
          },
          {
            ...
            content:
              "Essential practices for creating inclusive and accessible web experiences.",
            excerpt:
              "Learn how to build web applications that are accessible to all users, following WCAG guidelines.",
          ...
          },
          {
            ...
            excerpt:
              "Explore the essential principles and patterns for designing robust APIs that stand the test of time.",
                ...
                <div className="space-y-8">
                  {filteredBlogs.length > 0 ? (
                    filteredBlogs.map((blog) => (
                      <Card
                        key={blog._id}
                        className="group hover:shadow-xl transition-all duration-300 bg-gray-900/50 border-gray-700 hover:border-gray-600 overflow-hidden"
                      >
                        <div className="flex flex-col md:flex-row">
                          ...
                          <div className="flex-1 p-6">
                            ...
                            <Link
                              to={`/blog/${blog.slug}`}
                              className="inline-flex items-center text-gray-400 hover:text-gray-300 font-medium transition-colors group"
                            >
                              Read More
