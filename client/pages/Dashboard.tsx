      ...
      <Layout>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            <TabsList className="flex flex-wrap w-full bg-gray-900/50">
              <TabsTrigger
                value="overview"
                className="flex-1 min-w-[120px] data-[state=active]:bg-purple-600"
              >
                Overview
              </TabsTrigger>
              <TabsTrigger
              ...
              {favorites.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {favorites.map((asset) => (
                    <Card
                      key={asset._id}
                      className="group hover:shadow-lg transition-shadow bg-gray-900/50 border-gray-700"
                    >
                ...
                <Card className="bg-gray-900/50 border-gray-700">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-gray-400 mb-4">
                      Start exploring and add assets to your favorites
                    </p>
              ...
              {downloads.length > 0 ? (
                ...
                <Card className="bg-gray-900/50 border-gray-700">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-gray-400 mb-4">
                      Download assets to access them here
                    </p>
                    <Button onClick={() => navigate("/explore")}>
                      Browse Assets
                    </Button>
