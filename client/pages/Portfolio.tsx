...
export default function Portfolio() {
  ...
  const setDemoPortfolios = () => {
    const demoPortfolios: Portfolio[] = [
      ...
      },
      {
        ...
        description: 'Secure and intuitive mobile banking application with biometric authentication, transaction tracking, and investment portfolio management.',
        category: 'Mobile App',
        image: '/placeholder.svg',
      ...
      },
      {
        ...
        description: 'Complete brand identity design for a sustainable fashion startup, including logo, color palette, typography, and brand guidelines.',
        category: 'Branding',
        image: '/placeholder.svg',
      ...
      },
      {
        ...
        description: 'Modern and appetizing UI design for a food delivery application with smooth animations and intuitive user experience.',
      ...
      },
      {
        ...
        description: 'Real-time cryptocurrency portfolio tracking application with market analysis, price alerts, and trading insights.',
        category: 'Web Development',
        image: '/placeholder.svg',
        projectUrl: 'https://crypto-tracker-demo.com',
        githubUrl: 'https://github.com/example/crypto-tracker',
        technologies: ['Next.js', 'TypeScript', 'Chart.js', 'TailwindCSS', 'CoinGecko API'],
        featured: true,
        status: 'published',
      ...
      },
      {
        ...
        description: 'Comprehensive analytics dashboard for social media managers to track performance across multiple platforms.',
        category: 'Web Development',
        image: '/placeholder.svg',
      ...
      },
      {
        ...
        description: 'Interactive e-learning platform with video streaming, progress tracking, quizzes, and certification management.',
        category: 'Web Development',
        image: '/placeholder.svg',
  ...
  const filteredPortfolios = portfolios
    .filter((portfolio) => {
      ...
      return matchesSearch && matchesCategory && matchesTechnology && portfolio.status === 'published';
    })
    .sort((a, b) => {
      switch (sortBy) {
        case 'newest':
  ...
  const featuredPortfolios = portfolios.filter(p => p.featured && p.status === 'published').slice(0, 3);
      ...
      <div className="min-h-screen bg-background">
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredPortfolios.map((portfolio) => (
                  <Card key={portfolio._id} className="group bg-gray-900/50 border-gray-700 hover:border-gray-600 transition-all duration-300 overflow-hidden">
                    <div className="relative">
                      ...
                      <div className="absolute top-4 right-4">
                        <Badge variant="outline" className="bg-black/30 border-gray-500 text-white">
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          {portfolio.githubUrl && (
                            <Button size="sm" variant="outline" className="border-gray-500 text-white hover:bg-gray-800">
              ...
              <div className="flex items-center gap-4">
                <Select value={sortBy} onValueChange={setSortBy}>
                  ...
                  <SelectContent className="bg-gray-800 border-gray-600">
                    ...
                    <SelectItem value="popular" className="text-white">Most Viewed</SelectItem>
                    <SelectItem value="liked" className="text-white">Most Liked</SelectItem>
                  </SelectContent>
                </Select>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
                  ...
                  >
                    <div className={`relative ${viewMode === 'list' ? 'md:w-1/3' : ''}`}>
                      ...
                      <div className="absolute top-3 left-3 flex gap-2">
                        <Badge variant="outline" className="bg-black/50 border-gray-500 text-white text-xs">
                          {getCategoryIcon(portfolio.category)}
                          <span className="ml-1">{portfolio.category}</span>
                        </Badge>
                        {portfolio.difficulty && (
                          <Badge 
                            ...
                            className={`bg-black/50 border-gray-500 text-xs ${
                              portfolio.difficulty === 'Beginner' ? 'text-green-400' :
                              portfolio.difficulty === 'Intermediate' ? 'text-yellow-400' :
                              'text-red-400'
                            }`}
                          >
                            {portfolio.difficulty}
                    ...
                    <CardContent className={`p-6 ${viewMode === 'list' ? 'md:w-2/3' : ''}`}>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {portfolio.technologies.slice(0, 4).map((tech, index) => (
                          <Badge 
                            key={index} 
                            variant="secondary" 
            ...
            {/* Load More Button */}
            {filteredPortfolios.length > 0 && filteredPortfolios.length >= 9 && (
          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Get inspired by these projects or let's collaborate on something amazing together.
              </p>
